...
func New(seed uint64) *Xoshiro512starstar {
	m := new(Xoshiro512starstar)
	m.Seed(seed)
	return m
}

// Seed reinitialises the xoshiro256** random number generator with the given seed
func (r *Xoshiro512starstar) Seed(seed uint64) {
...
func (r *Xoshiro512starstar) Uint64() uint64 {
	x := r.s[1] * 5
	result := ((x << 7) | (x >> 57)) * 9
	t := r.s[1] << 11
	r.s[2] ^= r.s[0]
...
func (r *Xoshiro512starstar) Jump() {
...
func (r *Xoshiro512starstar) Longjump() {
