...
static __inline__ int haveAESNI() { return 0; }
...
static __inline__ uint32_t mulhilo32(uint32_t a, uint32_t b, uint32_t *hip) {
  uint64_t product = ((uint64_t)a) * ((uint64_t)b);
  *hip = product >> 32;
  return (uint32_t)product;
}

static __inline__ struct r123array1x32
_philox2x32bumpkey(struct r123array1x32 key) {
  key.v[0] += ((uint32_t)0x9E3779B9);
  return key;
}
static __inline__ struct r123array2x32
_philox4x32bumpkey(struct r123array2x32 key) {
  key.v[0] += ((uint32_t)0x9E3779B9);
  key.v[1] += ((uint32_t)0xBB67AE85);
  return key;
}
static __inline__ struct r123array2x32
_philox2x32round(struct r123array2x32 ctr, struct r123array1x32 key)
...
_philox4x32round(struct r123array4x32 ctr, struct r123array2x32 key)
    __attribute__((always_inline));
static __inline__ struct r123array4x32
_philox4x32round(struct r123array4x32 ctr, struct r123array2x32 key) {
  uint32_t hi0;
...
static __inline__ philox2x32_key_t philox2x32keyinit(philox2x32_ukey_t uk) {
  return uk;
}
static __inline__ philox2x32_ctr_t
philox2x32_R(unsigned int R, philox2x32_ctr_t ctr, philox2x32_key_t key)
    __attribute__((always_inline));
static __inline__ philox2x32_ctr_t
philox2x32_R(unsigned int R, philox2x32_ctr_t ctr, philox2x32_key_t key) {
  (__builtin_expect(!(R <= 16), 0)
       ? __assert_rtn(__func__, "philox.h", 349, "R<=16")
       : (void)0);
  if (R > 0) {
...
static __inline__ philox4x32_key_t philox4x32keyinit(philox4x32_ukey_t uk) {
  return uk;
}
static __inline__ philox4x32_ctr_t
philox4x32_R(unsigned int R, philox4x32_ctr_t ctr, philox4x32_key_t key)
    __attribute__((always_inline));
static __inline__ philox4x32_ctr_t
philox4x32_R(unsigned int R, philox4x32_ctr_t ctr, philox4x32_key_t key) {
  (__builtin_expect(!(R <= 16), 0)
       ? __assert_rtn(__func__, "philox.h", 350, "R<=16")
       : (void)0);
  if (R > 0) {
...
static __inline__ struct r123array1x64
_philox2x64bumpkey(struct r123array1x64 key) {
  key.v[0] += (0x9E3779B97F4A7C15ULL);
  return key;
}

static __inline__ struct r123array2x64
_philox2x64round(struct r123array2x64 ctr, struct r123array1x64 key)
    __attribute__((always_inline));
static __inline__ struct r123array2x64
_philox2x64round(struct r123array2x64 ctr, struct r123array1x64 key) {
  uint64_t hi;
...
static __inline__ philox2x64_key_t philox2x64keyinit(philox2x64_ukey_t uk) {
  return uk;
}
static __inline__ philox2x64_ctr_t
philox2x64_R(unsigned int R, philox2x64_ctr_t ctr, philox2x64_key_t key)
    __attribute__((always_inline));
static __inline__ philox2x64_ctr_t
philox2x64_R(unsigned int R, philox2x64_ctr_t ctr, philox2x64_key_t key) {
  (__builtin_expect(!(R <= 16), 0)
       ? __assert_rtn(__func__, "philox.h", 358, "R<=16")
       : (void)0);
  if (R > 0) {
...
static __inline__ philox4x64_key_t philox4x64keyinit(philox4x64_ukey_t uk) {
  return uk;
}
...
static __inline__ struct r123array4x64
...
static __inline__ philox4x64_ctr_t
...
philox4x64_R(unsigned int R, philox4x64_ctr_t ctr, philox4x64_key_t key) {
  (__builtin_expect(!(R <= 16), 0)
       ? __assert_rtn(__func__, "philox.h", 359, "R<=16")
       : (void)0);
  if (R > 0) {
